...
*   **Scan Ruby Gems:** Scan your global Ruby gems.
*   **Scan PHP Packages:** Scan your global PHP Composer packages.
*   **Scan Rust Packages:** Scan your global Rust Cargo source folders.
*   **Scan Go Packages:** Scan your global Go module folders.
...
Scan the user's standard Documents folder:
```bash
