...
*   **Project & Build Files:** Scan `package.json`, `composer.json`, `pyproject.toml`, `requirements.txt`, `requirements.in`, `deno.json`, `deno.jsonc`, `tasks.json`, `launch.json`, `Dockerfile`, `Makefile`, and Docker Compose.
