...
2.  **Create and activate a virtual environment (Recommended):**
    Using a virtual environment keeps your project dependencies separate from your global system packages. This avoids permission errors or conflicts with your system.
...
3.  **Install mandatory packages:**
    Once you have activated your virtual environment, run the appropriate command to install the required packages:
