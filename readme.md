...
*   **Exit:** Close the scanner application.

#### Scan Menu
##### Common Scans
*   **Scan Now (Enter):** Start scanning the current target path.
*   **Cancel Scan (Esc):** Stop the active scan in progress.
...
#### Help Menu
*   **Keyboard Shortcuts...:** Open a dialog displaying all global keyboard shortcuts.
*   **About:** Display application version and information.
