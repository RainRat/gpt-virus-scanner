...
*   **DevOps & Build Scripts:** Analyzes `Dockerfile`, `Makefile`, and CI/CD workflows (GitHub Actions, GitLab CI).
...
*   **Scan URL...:** Scan a script, Notebook, HTML, Markdown file, `Dockerfile`, `Makefile`, manifest (package.json, `deno.jsonc`, etc.), PR/MR (GitHub/GitLab), or archive (.zip, .tar, .tar.gz) directly from a web link.
