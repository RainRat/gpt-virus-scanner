...
*   **Web & Project Files:** Scans HTML, Markdown, `package.json`, `composer.json`, `deno.json`, and `deno.jsonc`.
...
*   **Scan URL...:** Scan a file, Notebook, or GitHub PR directly from a link.
