...
#### Scan Menu
##### Common Scans
*   **Scan Now (Enter):** Start scanning the configured target.
*   **Cancel Scan (Esc):** Stop the currently active scan.
...
#### Help Menu
*   **Keyboard Shortcuts...:** Open the keyboard shortcuts reference window.
*   **About:** View program version and application details.
