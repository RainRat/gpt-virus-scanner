...
*   `-l`, `--paths-only` / `--files-with-matches`: Print only the unique file paths of suspicious findings.
...
*   `-l`, `--paths-only` / `--files-with-matches`: Print only the unique file paths of suspicious findings line-by-line without headers.
