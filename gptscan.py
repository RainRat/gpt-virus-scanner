...
def generate_console_report(results: List[Dict[str, Any]], use_color: bool = False) -> str:
    ...
    for i, r in enumerate(results, 1):
        ...
        meta_parts = [f"{GRAY}Local:{RESET} {BOLD}{color_conf(own_conf)}{RESET}"]
        if gpt_conf:
            meta_parts.append(f"{GRAY}AI:{RESET} {BOLD}{color_conf(gpt_conf)}{RESET}")
        ...
        for line in snippet_lines:
            ...
            lines.append(f"    {GRAY}> {clean_line}{RESET}")
        lines.append("")
