...
def generate_yaml(results: List[Dict[str, Any]]) -> str:
    ...
    try:
        ...
        raise ImportError("PyYAML is required for YAML export. Please run 'pip install pyyaml'.")
...
def parse_yaml_content(content: str) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        raise ImportError("PyYAML is required for YAML import. Please run 'pip install pyyaml'.")
...
def parse_report_content(content: str, filename_hint: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    if ext in ('.yaml', '.yml') or (':' in content and 'path:' in content):
        # YAML report format
