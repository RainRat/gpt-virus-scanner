...
def set_scanning_state(is_scanning: bool) -> None:
    ...
    footer_buttons = [
        rescan_button, analyze_button, exclude_button, intel_button, results_button
    ]
...
def create_gui(initial_path: Optional[str] = None) -> tk.Tk:
    ...
    bind_hover_message(intel_button, "Access threat intelligence and online repository links.")
