...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Scan scripts, archives (ZIP/TAR), Jupyter Notebooks, package manifests (package.json, composer.json, deno.json, deno.jsonc), build files (Dockerfile, Makefile), CI/CD workflows (GitHub Actions, GitLab CI), Markdown files, HTML files, patches (.diff/.patch), git diffs, and web links (GitHub/GitLab/Bitbucket/Gist) for malicious code using AI.",
        epilog="Examples:\n"
