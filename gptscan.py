...
def view_details(event: Optional[tk.Event] = None, item_id: Optional[str] = None) -> None:
    ...
    def copy_as_markdown_details():
        ...
        if results:
            ...
            root.clipboard_clear()
            root.clipboard_append(md_content)
            set_local_status("Result copied as Markdown Table.", temporary=True)
    ...
    def copy_as_sarif_details():
        ...
        if results:
            ...
            root.clipboard_clear()
            root.clipboard_append(sarif_json)
...
def copy_as_sarif(event: Optional[tk.Event] = None) -> None:
    ...
    tree.clipboard_clear()
    tree.clipboard_append(sarif_json)
