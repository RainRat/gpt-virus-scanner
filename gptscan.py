...
if __name__ == "__main__":
    ...
    if args.cli:
        if not scan_target:
            parser.error('Scan target is required in CLI mode (provide positional argument or --path)')
        run_cli(scan_target, args.deep, args.show_all, args.use_gpt, args.rate_limit)
    else:
