...
def create_gui(initial_path: Optional[str] = None) -> tk.Tk:
    ...
    reveal_button = ttk.Button(footer_frame, text="Reveal in Folder", command=show_in_folder)
    reveal_button.grid(row=0, column=5, padx=2)
    ...
    import_button.grid(row=0, column=7, padx=2)
    ...
    export_button.grid(row=0, column=8, padx=2)
    ...
    clear_button.grid(row=0, column=9, padx=(2, 0))
