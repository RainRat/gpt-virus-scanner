...
def generate_sarif(results: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    sarif_results = []
    for r in results:
        # Convert threat level strings to numeric values
...
REPORT_FIELD_MAPPING = {
    ...
    "own_conf": ["own_conf", "Local Threat", "Local Threat Level", "Local Conf.", "local_conf", "Confidence", "Threat Level"],
    "admin_desc": ["admin_desc", "Admin Notes", "admin", "Analysis"],
    "end-user_desc": ["end-user_desc", "User Notes", "user_desc", "Analysis"],
    "gpt_conf": ["gpt_conf", "AI Threat", "AI Threat Level", "AI Conf.", "ai_conf", "Confidence", "Threat Level"],
...
def view_details(event: Optional[tk.Event] = None, item_id: Optional[str] = None) -> None:
    ...
    def copy_analysis():
        ...
        text = f"Path: {path}\nLocal Threat Level: {own_conf}\n"
        if gpt_conf:
            text += f"AI Threat Level: {gpt_conf}\n"
