...
def view_details(event: Optional[tk.Event] = None, item_id: Optional[str] = None) -> None:
    ...
    bind_hover_message(copy_menu_btn, "Copy analysis, JSON, or code to clipboard.", label=status_bar)
    ...
    copy_menu.add_command(label="Copy JSON", command=copy_as_json_details, accelerator="Ctrl+J")
