...
def test_generate_console_report():
    ...
    # Verify dimmed labels and bold/colored values
    # Label should be GRAY (0;90m), Value should be BOLD (1m) + RED (1;91m) for 90%
    assert "\033[0;90mLocal:\033[0m \033[1m\033[1;91m90%\033[0m\033[0m" in report_color
    assert "\033[0;90mAI:\033[0m \033[1m\033[1;91m95%\033[0m\033[0m" in report_color
    # Admin label GRAY, Value BOLD
    assert "\033[0;90mAdmin:\033[0m \033[1mAdmin note\033[0m" in report_color
    # Snippet line prefixed with dimmed >
